        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/share/1GV8End9eU/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-cyan-500/30 rounded-lg hover:bg-cyan-400/10 hover:border-cyan-400 transition-all group">
              ...
              <a href="https://x.com/threenovator?s=21" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-cyan-500/30 rounded-lg hover:bg-cyan-400/10 hover:border-cyan-400 transition-all group">
                <svg className="w-5 h-5 text-cyan-400 group-hover:text-cyan-300" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                </svg>
              </a>
              <a href="https://www.linkedin.com/company/3novator-tech/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-cyan-500/30 rounded-lg hover:bg-cyan-400/10 hover:border-cyan-400 transition-all group">
                <svg className="w-5 h-5 text-cyan-400 group-hover:text-cyan-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@3novator.com" className="text-cyan-400 hover:text-cyan-300 transition-colors text-sm">threenovatortech@gmail.com</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <a href="tel:+923489164985" className="text-cyan-400 hover:text-cyan-300 transition-colors text-sm">+92 348 9164985</a>
                </div>
              </div>
            </div>
