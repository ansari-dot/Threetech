        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-cyan-100/60 max-w-2xl lg:max-w-3xl mx-auto leading-relaxed font-medium border-l-2 border-cyan-500/30 pl-4 sm:pl-6 lg:pl-8">
              Comprehensive SEO strategies and digital marketing solutions including on-page optimization, content marketing, and social media management to boost your online presence.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-cyan-950/10 border border-cyan-500/20 rounded-lg p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-neon font-bold text-white mb-3 sm:mb-4">SEO Optimization</h3>
                ...
                <div className="bg-cyan-950/10 border border-cyan-500/20 rounded-lg p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-neon font-bold text-white mb-3 sm:mb-4">Content Marketing</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                    {contentMarketing.map((service, idx) => (
                      <div key={idx} className="text-sm sm:text-base text-cyan-100/60">• {service}</div>
                    ))}
                  </div>
                </div>
                <div className="bg-cyan-950/10 border border-cyan-500/20 rounded-lg p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-neon font-bold text-white mb-3 sm:mb-4">Social Media</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                    {socialMedia.map((platform, idx) => (
                      <div key={idx} className="text-sm sm:text-base text-cyan-100/60">• {platform}</div>
                    ))}
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 lg:py-32 relative">
        <div className="container mx-auto px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-neon font-bold mb-8 text-white tracking-widest text-center">
                MARKETING <span className="text-cyan-400">FEATURES</span>
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-neon font-bold mb-6 sm:mb-8 text-white tracking-widest">
                  READY TO GROW <span className="text-cyan-400">YOUR BUSINESS</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-cyan-100/60 mb-8 sm:mb-12">
                  Let's boost your online presence with our expert SEO and marketing strategies.
            </p>
